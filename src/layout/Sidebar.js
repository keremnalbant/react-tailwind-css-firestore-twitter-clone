...
const Sidebar = () => {
    ...
    return (
        <div className='h-screen sticky top-0 flex flex-col justify-between w-72 px-2'>
            <div>
                <div className='mt-1 mb-1 flex items-center justify-center w-12 h-12 rounded-full hover:bg-gray-lightest transform transition-colors duration-300'>
                    <a href="home"><img src={twitterLogo} alt="Twitter Logo" className='w-9 h-9'/></a>
                </div>
